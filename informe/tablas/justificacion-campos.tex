\begin{longtable}{F{2.7cm} p{2.2cm} p{1.5cm} p{6.5cm}}
\toprule
...
enum (int) &
4 B &
Condición académica del estudiante (activo, inactivo, permiso, etc); no indica si el registro debe eliminarse \\

marcadoParaPurga &
int (bool a mano) &
4 B &
0 o 1; bandera de borrado lógico independiente del estado académico, para que \texttt{purgarInactivos()} nunca borre un expediente solo por estar en pausa o con permiso \\
